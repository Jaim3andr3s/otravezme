...
export default function AdminLoginPage() {
  ...
  return (
    <motion.div
      ...
      className="max-w-md mx-auto bg-surface rounded-xl shadow-sm border border-edge p-8"
    >
      <div className="flex items-center space-x-2 bg-gold-soft p-3 rounded-lg border border-edge mb-6">
        <ShieldCheck className="w-5 h-5 text-gold flex-shrink-0" />
        <p className="text-sm text-ink-muted">Solo para personal autorizado.</p>
      </div>
